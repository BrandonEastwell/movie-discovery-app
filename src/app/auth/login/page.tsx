        ...
        <div className="backdrop-blur-[20px] bg-white/10 rounded-2xl z-20 overflow-hidden">
            <div className="bg-midnight/90 p-15">
                <form className="flex flex-col text-center gap-4 py-10 px-20 place-self-center font-iconsolata">
                    <h1 className="text-center mb-2 text-4xl text-pearl-white font-bold">{"Sign In"}</h1>
                    ...
                    <div className="w-full flex flex-col gap-1">
                        <span className="font-iconsolata cursor-pointer text-pearl-white/80 text-lg">New here? <button onClick={navigateToSignup} className="font-iconsolata cursor-pointer bg-transparent text-pearl-white text-lg no-underline">Create an account</button></span>
