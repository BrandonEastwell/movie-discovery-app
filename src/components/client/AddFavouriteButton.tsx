...
export default function AddFavouriteButton({isFavourite, toggleFavourite} : {isFavourite: boolean, toggleFavourite: (event: React.MouseEvent<HTMLButtonElement, MouseEvent>) => void}) {
